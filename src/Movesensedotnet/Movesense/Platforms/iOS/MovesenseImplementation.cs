...
namespace Plugin.Movesense
{
    ...
    public partial class MovesenseImplementation : IMovesense
    {
        ...
        public async Task<IMovesenseDevice> ConnectMdsAsync(Guid Uuid)
        {
            ...
            await MdsConnectionListener.Current.EnsureInitializedAsync().ConfigureAwait(false);
            // Connect the device
        ...
        {
            return await new MdsConnectionService().DisconnectMdsAsync(Uuid).ConfigureAwait(false);
        }
