    ...
    public partial class DetailViewController : UIViewController
    {
        ...
        void ConfigureView()
        {
            ...
            if (IsViewLoaded && DetailItem != null)
            {
                ...
                MoveSenseBinding.MDSWrapper wrapper = new MoveSenseBinding.MDSWrapper();
                MoveSenseBinding.MDSResponseBlock block = new MoveSenseBinding.MDSResponseBlock(async (arg0) => DoThing(arg0, wrapper));
                MoveSenseBinding.MDSEventBlock eventBlock = (MoveSenseBinding.MDSEvent arg0) => DoTheOtherThing(arg0, wrapper);
